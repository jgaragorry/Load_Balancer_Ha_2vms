...
≈ $0.08 ≈ (57.67 / 730) por una hora de uso continuado.Destruye con destroy.sh inmediatamente después de la práctica para evitar cargos extra.
...
Crea RG, VNet, NSG, IP pública, Load Balancer, dos NICs y dos VMs Ubuntu 22.04 con NGINX vía cloud‑init. Añade las NICs al backend pool y muestra la URL final.
